...
from Components.pooling import Pooling

class PoolingLayer(ComponentCommonMethods):

    # Aparentemente problema com a versão do VHDL e o Modelsim
    # Principalmente t_ARRAY_OF_LOGIC_VECTOR
    def __init__(self, qtChannels=6,qtAddrs=2, dataWidth = 8, addrWidth = 10, maxAddr='0110000000', 
        ...
        self.startInstance()
        self.minimalComponentFileName = 'PoolingLayer'
        self.portMap =   { 'in': [Port('i_CLK','STD_LOGIC'),
                                  Port('i_CLR','STD_LOGIC'),
                                  Port('i_PIX_SHIFT_ENA','STD_LOGIC'),
                                  Port('i_IN_DATA',f't_ARRAY_OF_LOGIC_VECTOR(0 to {qtChannels-1})({dataWidth-1} downto 0)', initialValue="(others => (others => '0'))"),
