...
class RAM(ComponentCommonMethods):
    ...
    def __init__(self, dataWidth=8, addrWidth=10, size = 128):
        self.startInstance()
        self.minimalComponentFileName = f'RAM_{addrWidth}_{dataWidth}b_{size}'
        self.portMap =  { 'in': [
        ...
        self.addArrayTypeOnArchitecture(name='RAM_ARRAY',datatype=f'std_logic_vector ({dataWidth-1} downto 0)',size=size)
